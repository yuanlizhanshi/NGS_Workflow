...
The differential peaks could calculated with [DEseq2](https://bioconductor.org/packages/release/bioc/html/DESeq2.html), [edgeR](https://bioconductor.org/packages/release/bioc/html/edgeR.html), [DiffBind](http://www.bioconductor.org/packages/release/bioc/html/DiffBind.html) and [THOR](https://reg-gen.readthedocs.io/en/latest/thor/introduction.html). (The identification of differential peaks is still controversial and you should read the literature carefully).\
